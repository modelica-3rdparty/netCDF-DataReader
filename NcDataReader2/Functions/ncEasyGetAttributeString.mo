...
function ncEasyGetAttributeString "get an attribute from a netCDF file as String"
    ...
    output String a;
    external "C" a=ncEasyGetAttributeString(fileName, varName, attName) annotation(__iti_dll = "ITI_ncDataReader2.dll", Include = "#include <ncDataReaderEA.h>", Library = {"ncDataReader2", "netcdf"});
