...
model FullAPI "Test model for NcDataReader2 using the full API"
    ...
    function getV1 "get v1 from file"
        ...
        input Real x;
        output Real y;
        external "C" y=getV1(fileName, x) annotation(__iti_dll = "ITI_ncDataReader2.dll", Include = "#include <FullAPIFunctions.h>", Library = {"ncDataReader2", "netcdf"});
    end getV1;
    ...
    function getV2 "get v2 from file"
        ...
        input Real x;
        output Real y;
        external "C" y=getV2(fileName, x) annotation(__iti_dll = "ITI_ncDataReader2.dll", Include = "#include <FullAPIFunctions.h>", Library = {"ncDataReader2", "netcdf"});
    end getV2;
